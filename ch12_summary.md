...
![그림 12-1](image_12-1.png)

예제의 각 노드에는 다른 두 링크로 이어지는 링크가 있다. 간결하게 묘사한다면

![그림 12-2](image_12-2.png)
...
![그림 12-16](image_12-16.png)

반면 3, 2, 4, 1, 5 순서로 삽입하면 균형 잡힌 트리가 된다.

![그림 12-17](image_12-17.png)
...
![그림 12-28](image_12-22.png)

![그림 12-29](image_12-29.png)
